...
--STEP3: CALCULATE DATE INTERVAL BETWEEN GAMEDATE & INJURYDATE
...
--STEP4PRE: FILTER FOR PRE-INJURY GAMES
select *
into #STEP4pre
from #STEP3
...
--STEP4POST: FILTER FOR POST-INJURY GAMES
select *
into #STEP4post
from #STEP3
where DaysBtwnInjury > 0;
...
--STEP5PRE: RANK DAYSBTWNINJURY FOR PRE-INJURY GAMES. THIS WILL HELP IDENTIFY MOST RECENT GAMES LEADING
UP TO THE INJURY
...
--STEP5POST: RANK DAYSBTWNINJURY FOR POST-INJURY GAMES. THIS WILL HELP IDENTIFY MOST RECENT GAMES AFTER
...
--STEP6PRE: REMOVE RANKS ABOVE 20 FOR PRE-INJURY GAMES. THE AVERAGE MLB PITCHER APPEARS IN 
...
--STEP6POST: REMOVE RANKS ABOVE 20 FOR POST-INJURY GAMES.
...
--STEP7: COMBINE PRE & POST INJURY DATA BACK TOGETHER
select * into #STEP7 from (
select * from #STEP6pre
UNION ALL
select * from #STEP6post) a;

--STEP8: MERGE PITCH DATA TO OUR LIST OF THE 20 MOST RECENT GAMES 
...
--STEP9: CREATE A FLAG (TWENTYDAYWINDOW) WHICH ONLY FLAGS PLAYER-INJURIES WITH A FULL 20 GAMES BEFORE
...
--STEP10: JOIN TWENTYDAYWINDOW FLAG BACK TO DATASET
